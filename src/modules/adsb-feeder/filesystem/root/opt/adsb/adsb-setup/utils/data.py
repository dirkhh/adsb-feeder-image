...
class Data:
    ...
    _env = {
        ...
        Env(
            ...
            default=False,
            tags=["biast_2", "is_enabled", "false_is_empty"],
        ),
        Env(
        ...
        Env("FEEDER_SERIAL_ACARS2", tags=["acars2serial"]),
        Env("FEEDER_SERIAL_VDLM2", tags=["vdlm2serial"]),
        Env("ACARS_SDR_STRING", default="", tags=["acars_sdr_string"]),
        Env("ACARS_GAIN", default="", tags=["acars_gain"]),
        Env("ACARS_FREQUENCIES", default="", tags=["acars_frequencies"]),
        Env("ACARS2_SDR_STRING", default="", tags=["acars2_sdr_string"]),
        Env("ACARS2_GAIN", default="", tags=["acars2_gain"]),
        Env("ACARS2_FREQUENCIES", default="", tags=["acars2_frequencies"]),
        ...
        Env("VDLM_SDR_STRING", default="", tags=["vdlm_sdr_string"]),
        Env("VDLM_GAIN", default="", tags=["vdlm_gain"]),
        Env("VDLM_FREQUENCIES", default="", tags=["vdlm_frequencies"]),
        ...
        Env("FEEDER_ACARSHUB_EXTERNAL_ACARSVDLM", default="external", tags=["acarshub_acarsvdlm"]),
        ...
        Env("AIS_RTLSDR_DEVICE_BANDWIDTH", default="", tags=["ais_rtlsdr_device_bandwidth"]),
        ...
        Env("AIS_BOATBEACON_SHAREDATA", default="", tags=["ais_boatbeacon_sharedata"]),
        ...
        Env("AIS_SDRMAP_STATION_ID", default="", tags=["ais_sdrmap_station_id"]),
        Env("AIS_SDRMAP_PASSWORD", default="", tags=["ais_sdrmap_password"]),
        Env("AIS_SHIPFINDER_SHAREDATA", default="", tags=["ais_shipfinder_sharedata"]),
        Env("AIS_SHIPPINGEXPLORER_UDP_PORT", default="", tags=["ais_shippingexplorer_udp_port"]),
        Env("AIS_SHIPXPLORER_SHARING_KEY", default="", tags=["ais_shipxplorer_sharing_key"]),
        Env("AIS_SHIPXPLORER_SERIAL_NUMBER", default="", tags=["ais_shipxplorer_serial_number"]),

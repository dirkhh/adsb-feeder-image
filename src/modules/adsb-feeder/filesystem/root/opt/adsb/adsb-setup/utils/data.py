...
class Data:
    ...
    _env = {
        ...
        Env("AIS_FEED_AISBOATBEACON", default=False, tags=["ais_feed_aisboatbeacon", "is_enabled"]),
        Env("AIS_FEED_AISHPRADAR", default=False, tags=["ais_feed_ais_hpradar", "is_enabled"]),
        Env("AIS_FEED_AISMARINETRAFFIC", default=False, tags=["ais_feed_ais_marinetraffic", "is_enabled"]),
        Env("AIS_FEED_AISMYSHIPTRACKING", default=False, tags=["ais_feed_ais_myshiptracking", "is_enabled"]),
        ...
        Env("SONDE_SDR_BIASTEE", default="False", tags=["sondebiastee"]),

...
class Data:
    ...
    _env = {
        ...
        Env(
            ...
            default=False,
            tags=["1090biast", "is_enabled", "false_is_empty"],
        ),
        Env(
            "FEEDER_ENABLE_BIASTEE_2",
            default=False,
            tags=["1090_2biast", "is_enabled", "false_is_empty"],
        ),
        Env(
            "FEEDER_ENABLE_UATBIASTEE",
            default=False,
            tags=["978biast", "is_enabled", "false_is_empty"],
        ),
        ...
        Env("SONDE_SDR_BIASTEE", default="False", tags=["sondebiast"]),

    ...
    def wait_for_target_page(
        ...
        try:
            ...
            WebDriverWait(self.driver, initial_wait_seconds).until(
                lambda d: self.WAITING_URL_PART in d.current_url or target_title in d.title
            )
            ...
            if self.WAITING_URL_PART in current_url:
            ...
            raise PageTransitionError(f"Failed to reach page with title '{target_title}' within timeout") from e

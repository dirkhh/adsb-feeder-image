...
# run the Python linter checks locally
	...
	echo "=== Running black ==="; \
	$$BLACK --check --line-length 130 src/modules/adsb-feeder/filesystem/root/opt/adsb/adsb-setup || FAILURES="$$FAILURES black in adsb-setup,"; \
	$$BLACK --check --line-length 130 src/tools --exclude venv --exclude __pycache__ || FAILURES="$$FAILURES black in tools,"; \
	echo "=== Running ruff ==="; \
